...
setwd("/home/y306n/OE0219YUYU/GSE77965")
...
sampleSheet <- file.path(datasetDir, "dataset", "sample_annotation_bmk.csv")
reportDir <- file.path(resultDir, "report_colon_11252021")
################################################################################
